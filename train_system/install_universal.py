...
class EnvironmentDetector:
    ...
    def detect_environment() -> str:
        ...
        # Check for Jupyter
        if ('JUPYTER_SERVER_ROOT' in os.environ or
...
class CacheManager:
    ...
    def clean_thoroughly(self) -> List[str]:
        ...
        build_artifacts = [
            ...
            '.ruff_cache', '.black_cache'
        ]
        
        cache_patterns = [
            '__pycache__', '*.pyc', '*.pyo', '*.pyd', '*~',
            '.DS_Store', '*.tmp', '*.temp', '.ipynb_checkpoints',
            'Thumbs.db', '*.swp', '*.swo', '.vscode/.ropeproject'
        ]
    ...
    def _clean_items_in_directory(self, root: str, dirs: List[str], files: List[str], patterns: List[str]):
            ...
            for requirement in all_requirements:
                try:
                    ...
                    subprocess.check_call([
                        ...
                        requirement, '--quiet', '--no-warn-script-location'
                    ])
...
class UniversalInstaller:
    ...
    def print_environment_info(self):
        ...
        print(f"Platform: {self.platform_info['system']} {self.platform_info['architecture']}")
