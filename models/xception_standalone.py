...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Xception Standalone Deepfake Detector')
    parser.add_argument('--model_path', type=str, default=r'C:\Users\mingw\Desktop\training\trained\xception_best.pth', help='Path to the trained model weights')
