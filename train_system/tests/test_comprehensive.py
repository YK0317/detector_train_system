...
class TestDatasetHandling:
    ...
    def test_dataset_config_validation(self):
        ...
        configs = [
            {**TEST_CONFIG_MINIMAL, "data": {**TEST_CONFIG_MINIMAL["data"], "type": "image"}},
            {**TEST_CONFIG_MINIMAL, "data": {**TEST_CONFIG_MINIMAL["data"], "type": "csv"}},
            {**TEST_CONFIG_MINIMAL, "data": {**TEST_CONFIG_MINIMAL["data"], "type": "class_folders"}},
        ]
...
class TestIntegration:
    ...
    def test_complete_config_workflow(self):
        ...
        from train_system.config import UnifiedTrainingConfig, ConfigValidator, ConfigTemplateManager
        ...
        config = ConfigTemplateManager.create_config_from_template(
            "torchvision",
            model={'num_classes': 3, 'architecture': 'resnet18'},  # Changed from model_name
