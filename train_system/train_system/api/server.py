...
class TrainingAPI:
    ...
    def _setup_routes(self):
        ...
        def start_training():
            ...
            try:
                ...
                self.training_thread = threading.Thread(
                    target=self._run_training, args=(self.current_trainer,)
                )
        ...
        def stop_training():
            ...
            return jsonify(
                {"message": "Training stop requested", "status": self.training_status}
            )
        ...
        def get_results():
            ...
            return jsonify(
                {"results": self.training_results, "status": self.training_status}
            )
        ...
        def validate_config():
            ...
            try:
                ...
                return (
                    jsonify({"error": f"Validation failed: {str(e)}", "valid": False}),
                    400,
                )
