...
class PathResolver:
    ...
    @staticmethod
    def resolve_config_paths(config_dict: Dict[str, Any], base_dir: Optional[Path] = None) -> Dict[str, Any]:
        """
        ...
        """
        path_keys = {
            'path', 'train_path', 'val_path', 'test_path', 'output_dir', 
            'real_path', 'fake_path', 'checkpoint_path', 'data_path',
            'model_path', 'config_path', 'log_path'
        }
