...
class DataConfig:
    ...
    auto_split_enabled: bool = True  # Enable automatic train/val split when val_path is None
    train_split_ratio: float = 0.8   # Proportion of data used for training (0.8 = 80% train, 20% val)
    split_seed: Optional[int] = 42   # Random seed for reproducible splits (None for random)
...
class TrainingConfig:
    ...
    # Resume training
    resume_from_checkpoint: Optional[Union[str, bool]] = None  # Path to checkpoint or True for auto-find
...
class ExternalTrainerConfig:
    ...
    skip_unified_data_loading: bool = False  # Skip UnifiedDataset creation (for trainers that handle their own data)
