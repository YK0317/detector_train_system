    ...
    def _auto_detect_device() -> torch.device:
        ...
        if torch.cuda.is_available():
            ...
            if device_count > 1:
                ...
                logger.info(f"Selected CUDA device {best_device} out of {device_count} available")
        ...
        if device.type == "cuda" and torch.cuda.is_available():
            try:
                ...
                info.update({
                    ...
                    "memory_allocated_gb": round(torch.cuda.memory_allocated(device_idx) / (1024**3), 2),
                    "memory_cached_gb": round(torch.cuda.memory_reserved(device_idx) / (1024**3), 2),
