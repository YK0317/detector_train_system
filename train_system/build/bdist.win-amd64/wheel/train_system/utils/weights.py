...
class WeightManager:
    ...
    @staticmethod
    def find_weight_files(directory: Union[str, Path], 
                         pattern: str = "*checkpoint*") -> List[Path]:
        """
    ...
    @staticmethod
    def auto_find_checkpoint(directory: Union[str, Path], 
                           prefer_best: bool = True) -> Optional[Path]:
        """
    ...
    @staticmethod
    def convert_weight_format(input_path: Union[str, Path], 
                            output_path: Union[str, Path],
                            target_format: str = "pt") -> bool:
        """
    ...
    def get_weight_info(weight_path: Union[str, Path]) -> dict:
        ...
        try:
            ...
            info = {
                ...
                "keys": list(checkpoint.keys()) if isinstance(checkpoint, dict) else ["state_dict"]
            }
...
def find_weights_for_model(model_name: str, 
                          base_dir: str = "training_output",
    ...
    if model_dir.exists():
        ...
        if model_type == "yolo" or (model_type == "auto" and "yolo" in model_name.lower()):
        ...
        if subdir.is_dir():
            ...
            if weights:
                ...
                for weight in weights:
                    ...
                    print(f"  • {weight.name} ({size_mb:.1f}MB, epoch: {epoch}, acc: {acc})")
